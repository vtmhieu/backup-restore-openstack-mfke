...
func buildKubeDumpPodMeta(create *snapshotv1beta1.CreateKubeSnapshot) metav1.ObjectMeta {
	return metav1.ObjectMeta{
		...
		Labels: map[string]string{
			...
			"networking.gardener.cloud/to-shoot-apiserver":          gardenercorev1beta1.LabelNetworkPolicyAllowed,
			"networking.gardener.cloud/to-all-shoot-apiservers":     gardenercorev1beta1.LabelNetworkPolicyAllowed,
			...
			"networking.gardener.cloud/from-shoot-apiserver":        gardenercorev1beta1.LabelNetworkPolicyAllowed,
		},
