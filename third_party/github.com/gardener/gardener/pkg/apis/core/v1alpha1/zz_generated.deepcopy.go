...
func (in *Addons) DeepCopyInto(out *Addons) {
	*out = *in
	...
	if in.GpuOperator != nil {
		in, out := &in.GpuOperator, &out.GpuOperator
		*out = new(GpuOperator)
		(*in).DeepCopyInto(*out)
	}
	return
...
func (in *AutoUpgrade) DeepCopyInto(out *AutoUpgrade) {
	*out = *in
	if in.TimeUpgrade != nil {
		in, out := &in.TimeUpgrade, &out.TimeUpgrade
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
func (in *GpuOperator) DeepCopyInto(out *GpuOperator) {
	*out = *in
	out.Addon = in.Addon
	out.MigConfig = in.MigConfig
	in.MPS.DeepCopyInto(&out.MPS)
	return
}
...
func (in *MpsConfig) DeepCopyInto(out *MpsConfig) {
	*out = *in
	if in.Maxclient != nil {
		in, out := &in.Maxclient, &out.Maxclient
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrometheusGPU) DeepCopyInto(out *PrometheusGPU) {
	*out = *in
	out.Addon = in.Addon
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrometheusGPU.
func (in *PrometheusGPU) DeepCopy() *PrometheusGPU {
	if in == nil {
		return nil
	}
	out := new(PrometheusGPU)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ShootSpec) DeepCopyInto(out *ShootSpec) {
	*out = *in
	...
	if in.UsePrivateWan != nil {
		in, out := &in.UsePrivateWan, &out.UsePrivateWan
		*out = new(string)
		**out = **in
	}
	if in.PublicKey != nil {
