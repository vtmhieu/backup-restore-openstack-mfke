...
type ShootStatus struct {
	...
	// +optional
	TransactionId *string `json:"transactionId,omitempty" protobuf:"bytes,19,opt,name=transactionId"`
	// TransactionStatus holds information about operation in Portal (Processing || Succeeded || Failed)
	// +optional
	TransactionStatus string `json:"transactionStatus,omitempty" protobuf:"bytes,20,opt,name=transactionStatus"`
	// GPUSharingConfig holds information about gpu sharing config of shoot cluster (single/mixed/none/MPS)
	// +optional
	GPUSharingConfig string `json:"gpuSharingConfig,omitempty" protobuf:"bytes,18,opt,name=gpuSharingConfig"`
}
